...
```bash
git clone https://github.com/peacockery-studio/payload-next-template.git my-project && cd my-project
```
...
1. Finally run `bun start` to run Node in production and serve Payload from the `.build` directory.
